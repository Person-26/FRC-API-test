...
class ScorePredictor(nn.Module):
    def __init__(self, num_players = 100000, num_years = 30, num_events = 1000, embedding_dim = 64, hidden_dim = 2048):
        ...
        self.fc1 = nn.Linear(embedding_dim * 8, hidden_dim)  # Input: 6 player embeddings, event embedding, year embedding
    ...
    def forward(self, ids):
        ...
        player_ids = ids[:, 2:8]  # Slice along the second dimension
